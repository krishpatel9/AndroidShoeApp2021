...
public class HistoryRightFootFragment extends Fragment {
    ...
    public HistoryRightFootFragment(History hst){
        stepCnt = hst.getStepCnt();
        stepGoal = hst.getStepGoal();
        date = hst.getDate();
        time = hst.getTime();
        status = hst.getStatus_right();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        return (ViewGroup) inflater.inflate(
                R.layout.history_info_layout_right, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        reading1ImageView = getView().findViewById(R.id.rightGradient1ImageView);
        reading2ImageView = getView().findViewById(R.id.rightGradient2ImageView);
        reading3ImageView = getView().findViewById(R.id.rightGradient3ImageView);
        reading4ImageView = getView().findViewById(R.id.rightGradient4ImageView);
